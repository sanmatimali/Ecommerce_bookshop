...
<?php include('include/sidebar.php');?>
			<div class="app-content">
				...
				<div class="main-content" >
					...
					<input type="password" name="npass" id="npass" class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="New Password">
														</div>
